...
import es.ucm.fdi.tp.practica6.swings.AutomaticMoves.ListenerAutomaticMoves;
import es.ucm.fdi.tp.practica6.swings.PieceColors.ColorChangedListener;
import es.ucm.fdi.tp.practica6.swings.PlayerModes.PlayerModeChangedListener;
import es.ucm.fdi.tp.practica6.swings.QuitAndRestart.RestartAndQuitButtonListener;
import es.ucm.fdi.tp.practica6.swings.TimeIntelligent.TimeListener;
...
public class PanelConfiguration extends JPanel {
	...
	private TimeIntelligent timeIntelligent;
	...
	public PanelConfiguration(List<Piece> pieces, Piece viewPiece, Board board,
        ...
        timeIntelligent = new TimeIntelligent(timelistener);
        initComponents();
	}
